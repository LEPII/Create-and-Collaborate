...
const DropDownIcon = () => {
  return (
    <CardDeck className="jobContainer">
      <Card
      ...
      >
        <Card.Img
          ...
          src="https://s3-alpha-sig.figma.com/img/786e/6506/cba63599d8022e19ab281e5b6f494740?Expires=1607299200&Signature=KKOEcSEsRbbFk2ozBkSTfjmHe2-cjR7j9uG8evBOQV-i4rr0680GqOqPJsakaTautp3zOSnVfbPqlmPV9dQqFeZyRaC60oITIdhXYSgf4Z7Nr7Yp6Q4GRjv~MC-xq9ZDpifoQnLyDQYtx~JwJBUOd9mSLEnSC35c6H8TDaztVXGvsb~NgIlNxQH6xRPOtqrE~VFEjfQcK6xG58JCRiXGHAzmFz~4AfgbYWlrDPbfw0QgbI2B9GGFwp9QCvIOjt0PJmNl~a3zsowOVxtDb4vd2~hcqtARMmGMWqg6FeO5vV53mlwxcMln51RnVCUztpKwORV-3K44NJuWvca1h6gUZQ__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA"
        />
        <Card.Body>
          <Card.Title className="Create">@Art305</Card.Title>
          <Card.Text>
            “I chose Create & Collaborate because it was a platform of like
            minded people sharing content! Cant wait to see everyone's work”
          </Card.Text>
        </Card.Body>
      </Card>
      <Card
      ...
      >
        ...
        <Card.Body>
          ...
          <Card.Text>
            “Create & Collaborate has so many cool events, & they let me save
            them how awesome is that!!”{' '}
          </Card.Text>
        </Card.Body>
      </Card>
    </CardDeck>
